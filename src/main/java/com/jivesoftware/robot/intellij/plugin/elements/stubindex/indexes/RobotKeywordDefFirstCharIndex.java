 ...
 */
public class RobotKeywordDefFirstCharIndex extends StringStubIndexExtension<RobotKeywordTitle> {
    public static final StubIndexKey<String, RobotKeywordTitle> KEY = StubIndexKey.createIndexKey("Robot.keywordDef.startsWithFirstChar");
