 ...
 */
public class RobotKeywordDefFirstCharIndex extends StringStubIndexExtension<RobotKeywordDef> {
    public static final StubIndexKey<String, RobotKeywordDef> KEY = StubIndexKey.createIndexKey("Robot.keywordDef.startsWithFirstChar");
