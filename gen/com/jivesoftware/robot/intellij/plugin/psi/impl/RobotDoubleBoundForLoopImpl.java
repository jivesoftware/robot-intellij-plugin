...
public class RobotDoubleBoundForLoopImpl extends ASTWrapperPsiElement implements RobotDoubleBoundForLoop {

  public RobotDoubleBoundForLoopImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof RobotVisitor) ((RobotVisitor)visitor).visitDoubleBoundForLoop(this);
