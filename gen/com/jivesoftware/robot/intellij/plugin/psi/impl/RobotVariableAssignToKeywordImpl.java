...
public class RobotVariableAssignToKeywordImpl extends ASTWrapperPsiElement implements RobotVariableAssignToKeyword {

  public RobotVariableAssignToKeywordImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof RobotVisitor) ((RobotVisitor)visitor).visitVariableAssignToKeyword(this);
