...
public class RobotSettingsLineImpl extends ASTWrapperPsiElement implements RobotSettingsLine {
  ...
  public RobotSetting getSetting() {
    return findNotNullChildByClass(RobotSetting.class);
  }

  @Override
  @NotNull
  public List<RobotSettingArg> getSettingArgList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, RobotSettingArg.class);
  }
