...
public class RobotKeywordSettingImpl extends ASTWrapperPsiElement implements RobotKeywordSetting {

  public RobotKeywordSettingImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof RobotVisitor) ((RobotVisitor)visitor).visitKeywordSetting(this);
    else super.accept(visitor);
  }

  @Override
  @Nullable
  public RobotArgumentsSetting getArgumentsSetting() {
    return findChildByClass(RobotArgumentsSetting.class);
  }
