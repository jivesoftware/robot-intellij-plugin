...
public class RobotIndentedKeywordInvocationTestImpl extends ASTWrapperPsiElement implements RobotIndentedKeywordInvocationTest {

  public RobotIndentedKeywordInvocationTestImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof RobotVisitor) ((RobotVisitor)visitor).visitIndentedKeywordInvocationTest(this);
