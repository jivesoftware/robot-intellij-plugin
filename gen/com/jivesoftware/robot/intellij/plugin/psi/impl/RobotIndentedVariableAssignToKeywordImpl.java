...
public class RobotIndentedVariableAssignToKeywordImpl extends ASTWrapperPsiElement implements RobotIndentedVariableAssignToKeyword {

  public RobotIndentedVariableAssignToKeywordImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof RobotVisitor) ((RobotVisitor)visitor).visitIndentedVariableAssignToKeyword(this);
  ...
  public RobotIndentedKeywordInvocationTest getIndentedKeywordInvocationTest() {
    return findNotNullChildByClass(RobotIndentedKeywordInvocationTest.class);
  }
