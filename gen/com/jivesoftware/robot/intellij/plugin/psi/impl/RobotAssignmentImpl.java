...
public class RobotAssignmentImpl extends ASTWrapperPsiElement implements RobotAssignment {

  public RobotAssignmentImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof RobotVisitor) ((RobotVisitor)visitor).visitAssignment(this);
