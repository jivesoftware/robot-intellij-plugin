...
public class RobotSingleVariableListImpl extends ASTWrapperPsiElement implements RobotSingleVariableList {

  public RobotSingleVariableListImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof RobotVisitor) ((RobotVisitor)visitor).visitSingleVariableList(this);
