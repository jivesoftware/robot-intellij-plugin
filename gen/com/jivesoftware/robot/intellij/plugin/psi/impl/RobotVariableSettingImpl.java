...
public class RobotVariableSettingImpl extends ASTWrapperPsiElement implements RobotVariableSetting {

  public RobotVariableSettingImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof RobotVisitor) ((RobotVisitor)visitor).visitVariableSetting(this);
  ...
  public RobotResourceFile getResourceFile() {
    return findChildByClass(RobotResourceFile.class);
  }
