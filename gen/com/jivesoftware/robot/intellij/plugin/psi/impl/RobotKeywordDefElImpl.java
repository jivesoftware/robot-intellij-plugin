...
public class RobotKeywordDefElImpl extends RobotNamedElementImpl implements RobotKeywordDefEl {

  public RobotKeywordDefElImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof RobotVisitor) ((RobotVisitor)visitor).visitKeywordDefEl(this);
