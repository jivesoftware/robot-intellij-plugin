...
public class RobotExecutionLineImpl extends ASTWrapperPsiElement implements RobotExecutionLine {

  public RobotExecutionLineImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof RobotVisitor) ((RobotVisitor)visitor).visitExecutionLine(this);
