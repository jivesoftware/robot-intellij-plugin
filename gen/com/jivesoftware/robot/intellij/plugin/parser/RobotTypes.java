...
public interface RobotTypes {
  ...
  IElementType KEYWORD_INVOCATION = new RobotElementType("KEYWORD_INVOCATION");
  ...
  IElementType SETTING_ARG = new RobotElementType("SETTING_ARG");
  ...
  IElementType TESTCASE_LINE = new RobotToken("TESTCASE_LINE");
  ...
  class Factory {
    public static PsiElement createElement(ASTNode node) {
      ...
      else if (type == KEYWORD_INVOCATION) {
        return new RobotKeywordInvocationImpl(node);
      }
      ...
      else if (type == SETTING_ARG) {
        return new RobotSettingArgImpl(node);
      }
